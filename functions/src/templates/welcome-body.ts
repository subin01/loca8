						...
						<div
							...
							<div class="txtTinyMce-wrapper"
								...
								<p
									...
									<span style="font-size: 18px;">Your Tag <strong>${tid}</strong> is now activated! <br />You activation
										key is <strong>${key}</strong>. </span>
								</p>
								<p
								...
								<p
									style="margin: 0; font-size: 16px; line-height: 1.5; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
									<span style="font-size: 16px;">You might need above case you've problem with the login. So,
										Keep it safe!</span>
								</p>
								<p
									style="margin: 0; font-size: 16px; line-height: 1.5; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
								...
								<p
									style="margin: 0; font-size: 16px; line-height: 1.5; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
									<span style="font-size: 16px; color: #222222;">Please make sure this email address is marked
										as safe (probably add to your contact) so that it wouldn't go to Spam/Junk. We'll be using
										this email for any future communications related to a lost &amp; found reporting on any of
										your Tags.</span>
								</p>
								<p
									style="margin: 0; font-size: 16px; line-height: 1.5; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
